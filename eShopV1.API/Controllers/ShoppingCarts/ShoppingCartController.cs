...
using eShopV1.Application.ShoppingCarts.CreateOrUpdateCart;
using eShopV1.Application.ShoppingCarts.DeleteCart;
using eShopV1.Application.ShoppingCarts.GetCart;
using MediatR;
            ...
            CancellationToken cancellationToken)
        {
            var command = new CreateOrUpdateCartCommand(
                ...
                request.Items.Select(i => new CreateCartItemRequest(
                    ...
                    i.PictureUrl,
                    i.Currency)).ToList(),
                request.Coupon is not null ? new Application.ShoppingCarts.CreateOrUpdateCart.CouponRequest(
                    request.Coupon.Name,
